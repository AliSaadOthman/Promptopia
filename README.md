<div align="center">
  <br />
<img src="https://github.com/AliSaadOthman/Promptopia/blob/main/public/assets/images/Thumbnail.png" alt="Project Banner">
  <br />
...
```bash
git clone https://github.com/AliSaadOthman/Promptopia.git
cd Promptopia
```
